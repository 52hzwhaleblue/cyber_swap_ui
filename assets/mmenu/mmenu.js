! function(n) {
    ...
    function l(e, t) {
        for (var n in "object" != m(e) && (e = {}), "object" != m(t) && (t = {}), t) t.hasOwnProperty(n) && (void 0 === e[n] ? e[n] = t[n] : "object" == m(e[n]) && l(e[n], t[n]));
        return e
    }
    ...
    function E(e, t, n) {
        "number" == typeof e && (e = "(min-width: " + e + "px)"), L[e] = L[e] || [], L[e].push({
            yes: t,
            no: n
        })
    }
    ...
    function w(e, t) {
        for (var n = t.matches ? "yes" : "no", i = 0; i < L[e].length; i++) L[e][i][n]()
    }
    p({
        Menu: "Menu"
    }, "nl"), p({
    ...
    var x = (P.prototype.openPanel = function(t, e) {
        ...
        var n = this;
        this.trigger("initExtensions:before"), "array" == m(this.opts.extensions) && (this.opts.extensions = {
        ...
        if (e.matches(n) && (e.matches(".mm-panel") || (e = this._initPanel(e)), e)) {
            var i = [];
            i.push.apply(i, b(e, "." + this.conf.classNames.panel)), b(e, ".mm-listview").forEach(function(e) {
        ...
        if (i ? a && a.classList.add("mm-listitem_vertical") : this.node.pnls.append(e), a && ((a.mmChild = e).mmParent = a) && a.matches(".mm-listitem") && !b(a, ".mm-btn").length) {
            var o = b(a, ".mm-listitem__text")[0];
            if (o) {
                var r = h("a.mm-btn.mm-btn_next.mm-listitem__btn");
                r.setAttribute("href", "#" + e.id), o.matches("span") ? (r.classList.add("mm-listitem__text"), r.innerHTML = o.innerHTML, a.insertBefore(r, o.nextElementSibling), o.remove()) : a.insertBefore(r, b(a, ".mm-panel")[0])
            }
        }
        return this._initNavbar(e), b(e, "ul, ol").forEach(function(e) {
            t.initListview(e)
        ...
        if (this.trigger("initNavbar:before", [e]), !b(e, ".mm-navbar").length) {
            ...
            if (e.dataset.mmParent ? n = v(this.node.pnls, e.dataset.mmParent)[0] : (t = e.mmParent) && (n = t.closest(".mm-panel")), !t || !t.matches(".mm-listitem_vertical")) {
                ...
                switch (o.innerHTML = e.dataset.mmTitle || (a ? a.textContent : "") || this.i18n(this.opts.navbar.title) || this.i18n("Menu"), this.opts.navbar.titleLink) {
                    case "anchor":
        ...
        return t = e, "string" == typeof(n = this.conf.language) && void 0 !== f[n] && f[n][t] || t;
        var t, n
    }, P.version = "8.4.0", P.options = i, P.configs = s, P.addons = {}, P.wrappers = {}, P.node = {}, P.vars = {}, P);
    ...
    x.options.offCanvas = {
        ...
        var t = this;
        this.trigger("close:before"), this.vars.opened && (c(x.node.page, function() {
        ...
        e.classList.add("mm-page"), e.classList.add("mm-slideout"), e.id = e.id || d(), x.node.page = e, this.trigger("setPage:after", [e])
    };
    var T;
    p({
        ...
        D = (R.prototype.start = function(e) {
            ...
            switch (this.state) {
                ...
                case 2:
                    ...
                    var t = this._dragDirection(),
                        n = this._eventDetail(t);
                    1 == this.state && Math.abs(this.distance[this.axis]) > this.treshold.start && (this._dispatchEvents("drag*Start", n), this.state = 2), 2 == this.state && this._dispatchEvents("drag*Move", n)
            }
        ...
        if (void 0 !== e) {
            ...
            e.length && (e.forEach(function(e) {
                ...
                var t, n = h("div.mm-navbar"),
                    i = e.position;
                "bottom" !== i && (i = "top"), d[i] || (d[i] = h("div.mm-navbars_" + i)), d[i].append(n);
                for (var s = 0, a = e.content.length; s < a; s++) {
                    var o, r = e.content[s];
                    if ("string" == typeof r)
                        if ("function" == typeof(o = U.navbarContents[r])) o.call(l, n);
                        else {
                            var m = h("span");
                            m.innerHTML = r;
                            var c = b(m);
                ...
                "string" == typeof e.type && "function" == typeof(o = U.navbarTypes[e.type]) && o.call(l, n), "boolean" != typeof e.use && E(e.use, function() {
                    n.classList.remove("mm-hidden"), x.sr_aria(n, "hidden", !1)
                }, function() {
                    n.classList.add("mm-hidden"), x.sr_aria(n, "hidden", !0)
                })
            }), this.bind("initMenu:after", function() {
                for (var e in d) l.node.menu["bottom" == e ? "append" : "prepend"](d[e])
            }))
        }
    }
    x.options.navbars = [], x.configs.navbars = {
        ...
        breadcrumbs: function(e) {
            ...
            e.append(n), this.bind("initNavbar:after", function(e) {
                if (!e.querySelector(".mm-navbar__breadcrumbs")) {
                    ...
                    r.conf.navbars.breadcrumbs.removeFirst && t.shift(), n.innerHTML = t.join('<span class="mm-separator">' + r.conf.navbars.breadcrumbs.separator + "</span>"), b(e, ".mm-navbar")[0].append(n)
                }
        ...
        title: function(e) {
            ...
            e.append(o), this.bind("openPanel:start", function(e) {
                e.parentElement.matches(".mm-listitem_vertical") || ((i = e.querySelector("." + a.conf.classNames.navbars.panelTitle)) || (i = e.querySelector(".mm-navbar__title")), (t = i ? i.getAttribute("href") : "") ? o.setAttribute("href", t) : o.removeAttribute("href"), n = i ? i.innerHTML : "", o.innerHTML = n)
            }), this.bind("openPanel:start:sr-aria", function(e) {
                if (a.opts.screenReader.text && (s || b(a.node.menu, ".mm-navbars_top, .mm-navbars_bottom").forEach(function(e) {
                    ...
                    var t = !0;
                    "parent" == a.opts.navbar.titleLink && (t = !s.matches(".mm-hidden")), x.sr_aria(o, "hidden", t)
                }
            })
        }
    };
    ...
    x.prototype.search = function(i, s) {
        ...
        if (l.forEach(function(e) {
            ...
            }), r && (b(r, ".mm-listview")[0].innerHTML = ""), m.forEach(function(e) {
                e.scrollTop = 0
            }), s.length) {
            d.forEach(function(e) {
                ...
                var t, n = b(e, ".mm-listitem__text")[0],
                    i = !1;
                n && -1 < (t = n, Array.prototype.slice.call(t.childNodes).filter(function(e) {
                    return 3 == e.nodeType
                }).map(function(e) {
                    return e.textContent
                }).join(" ")).toLowerCase().indexOf(s) && (n.matches(".mm-listitem__btn") ? o.showSubPanels && (i = !0) : n.matches("a") ? i = !0 : o.showTextItems && (i = !0)), i || e.classList.add("mm-hidden")
            });
            ...
            if (o.panel.add) {
                ...
                }), (e = b(r, ".mm-listview")[0]).append.apply(e, p), this.openPanel(r)
            } else o.showSubPanels && m.forEach(function(e) {
                ...
                g(v(e, ".mm-listitem")).forEach(function(s) {
                    var e = function(e, t) {
                        for (var n = [], i = s.previousElementSibling; i;) i.matches(t) && n.push(i), i = i.previousElementSibling;
                        return n
                    }(0, ".mm-divider")[0];
            ...
            if (o.panel.splash) v(r, ".mm-panel__content").forEach(function(e) {
                return e.classList.remove("mm-hidden")
            });
    ...
    x.options.sidebar = {
        ...
        offcanvas: function() {
            ...
            if (this.opts.offCanvas) {
                var t = ("object" != typeof(e = this.opts.offCanvas) && (e = {}), e);
                this.opts.offCanvas = l(t, x.options.offCanvas);
                var n = this.conf.offCanvas;
                this._api.push("open", "close", "setPage"), this.vars.opened = !1, this.bind("initMenu:before", function() {
                    n.clone && (a.node.menu = a.node.menu.cloneNode(!0), a.node.menu.id && (a.node.menu.id = "mm-" + a.node.menu.id), v(a.node.menu, "[id]").forEach(function(e) {
                        e.id = "mm-" + e.id
                    })), a.node.wrpr = document.body, document.querySelector(n.menu.insertSelector)[n.menu.insertMethod](a.node.menu)
                }), this.bind("initMenu:after", function() {
                    (function() {
                        var t = this;
                        ...
                        if (e.blockUI) {
                            if (!x.node.blck) {
                                ...
                                i.innerHTML = "<a></a>", document.querySelector(n.menu.insertSelector).append(i), x.node.blck = i
                            }
                            var s = function(e) {
                                e.preventDefault(), e.stopPropagation(), t.node.wrpr.matches(".mm-wrapper_modal") || t.close()
                            };
                            x.node.blck.addEventListener("mousedown", s), x.node.blck.addEventListener("touchstart", s), x.node.blck.addEventListener("touchmove", s), this.trigger("initBlocker:after")
                        }
                    ...
                    if (n && e.matches('[href="#' + n + '"]')) {
                        ...
                        if (i) {
                            var s = i.mmApi;
                            if (s && s.close) return s.close(), c(i, function() {
                                a.open()
        ...
        scrollBugFix: function() {
            ...
            if (A && this.opts.offCanvas && this.opts.offCanvas.blockUI) {
                ...
                if (this.opts.scrollBugFix = l(t, x.options.scrollBugFix), t.fix) {
                    var i, s, a = (i = this.node.menu, s = "", i.addEventListener("touchmove", function(e) {
                        0 < e.movementY ? s = "down" : e.movementY < 0 && (s = "up"), s = null
                    }), {
                        get: function() {
                            return s
                        }
        ...
        autoHeight: function() {
            ...
            if (this.opts.autoHeight = l(a, x.options.autoHeight), "auto" == a.height || "highest" == a.height) {
                var o, t = (o = function(e) {
                    ...
                    if (!s.opts.offCanvas || s.vars.opened) {
                        ...
                        s.node.menu.classList.add("mm-menu_autoheight-measuring"), "auto" == a.height ? ((e = b(s.node.pnls, ".mm-panel_opened")[0]) && (e = o(e)), n = (e = e || b(s.node.pnls, ".mm-panel")[0]).scrollHeight) : "highest" == a.height && (t = 0, b(s.node.pnls, ".mm-panel").forEach(function(e) {
                            e = o(e), t = Math.max(t, e.scrollHeight)
                        }), n = t), s.node.menu.style.height = n + i + "px", s.node.menu.classList.remove("mm-menu_autoheight-measuring")
                    }
                });
                this.bind("initMenu:after", function() {
        ...
        backButton: function() {
            ...
            if (this.opts.offCanvas) {
                ...
                if (t.close) {
                    var s = [],
                        a = function() {
                            s = [i], b(n.node.pnls, ".mm-panel_opened, .mm-panel_opened-parent").forEach(function(e) {
                                s.push("#" + e.id)
                            })
                        };
                    this.bind("open:finish", function() {
                        ...
                        if (n.vars.opened && s.length) {
                            ...
                            t == i ? n.close() : (n.openPanel(n.node.menu.querySelector(t)), history.pushState(null, document.title, i))
                        }
                    })
                }
        ...
        counters: function() {
            ...
            if (this.opts.counters = l(i, x.options.counters), this.bind("initListview:after", function(e) {
        ...
        drag: function() {
            ...
            if (this.opts.offCanvas) {
                ...
                this.opts.drag = l(n, x.options.drag), n.open && this.bind("setPage:after", function(e) {
                    (function(e) {
                        var i = this,
                            s = {},
                            a = !1,
                        ...
                        B && (M(B, "dragStart"), M(B, "dragMove"), M(B, "dragEnd")), q = new D(B = e), t(), t = function() {}, B && (S(B, "dragStart", function(e) {
                            e.detail.direction == s.direction && (a = !0, i.node.wrpr.classList.add("mm-wrapper_dragging"), i._openSetup(), i.trigger("open:start"), z = i.node.menu["x" == s.axis ? "clientWidth" : "clientHeight"])
        ...
        dropdown: function() {
            ...
            if (this.opts.offCanvas) {
                ...
                if (g.drop) {
                    var y;
                    this.bind("initMenu:after", function() {
                        if (n.node.menu.classList.add("mm-menu_dropdown"), "string" != typeof g.position.of) {
                        ...
                        if ("string" == typeof g.position.of) {
                            ...
                            var t = g.event.split(" ");
                            1 == t.length && (t[1] = t[0]), "hover" == t[0] && y.addEventListener("mouseenter", function() {
                                n.open()
                            }, {
                                passive: !0
                    ...
                    var i = function(e, t) {
                        var n, i, s, a = t[0],
                            ...
                            p = null,
                            u = (n = m, y.getBoundingClientRect()[n] + document.body["left" == n ? "scrollLeft" : "scrollTop"]),
                            h = u + y[r],
                            v = window[d],
                        ...
                        return null === p && (p = u + (h - u) / 2 < v / 2 ? "after" : "before"), "after" == p ? (s = v - ((i = "x" == e ? u : h) + b), a[m] = i + _.offset.button[e] + "px", a[c] = "auto", g.tip && o.push("mm-menu_tip-" + ("x" == e ? "left" : "top"))) : (s = (i = "x" == e ? h : u) - b, a[c] = "calc( 100% - " + (i - _.offset.button[e]) + "px )", a[m] = "auto", g.tip && o.push("mm-menu_tip-" + ("x" == e ? "right" : "bottom"))), g.fitViewport && (a[f] = Math.min(_[l].max, s) + "px"), [a, o]
                    };
            ...
            function t() {
                ...
                if (this.vars.opened) {
                    ...
                    for (var n in e = i.call(this, "y", e), (e = i.call(this, "x", e))[0]) this.node.menu.style[n] = e[0][n];
        ...
        fixedElements: function() {
            ...
            if (this.opts.offCanvas) {
                ...
                this.bind("setPage:after", function(e) {
                    n = t.conf.classNames.fixedElements.fixed, i = v(document, s.insertSelector)[0], v(e, "." + n).forEach(function(e) {
        ...
        iconbar: function() {
            var o, e, i = this,
                r = ("array" == m(e = this.opts.iconbar) && (e = {
                    use: !0,
                    top: e
                }), "object" != m(e) && (e = {}), void 0 === e.use && (e.use = !0), "boolean" == typeof e.use && e.use && (e.use = !0), e);
            if (this.opts.iconbar = l(r, x.options.iconbar), r.use && (["top", "bottom"].forEach(function(e, t) {
                    var n = r[e];
                    "array" != m(n) && (n = [n]);
                ...
                if ("boolean" == typeof r.use ? this.bind("initMenu:after", n) : E(r.use, n, function() {
                    ...
                    o.classList.add("mm-iconbar_tabs"), o.addEventListener("click", function(e) {
                        var t = e.target;
                        if (t.matches("a"))
            ...
            if ("first" == s.visible && (a = !0, s.visible = 1), s.visible = Math.min(3, Math.max(1, s.visible)), s.visible++, s.add) {
                ...
                this.bind("openPanel:start", function(t) {
                    ...
                    if (s.blockPanel && !e.parentElement.matches(".mm-listitem_vertical") && !b(e, ".mm-panel__blocker")[0]) {
                        ...
                        t.setAttribute("href", "#" + e.closest(".mm-panel").id), e.prepend(t)
                    }
                })
            }
        },
        keyboardNavigation: function() {
            ...
            if (!A) {
                ...
                if (this.opts.keyboardNavigation = l(a, x.options.keyboardNavigation), a.enable) {
                    ...
                    this.bind("initMenu:after", function() {
                                ...
                                M(document.body, "keydown.tabguard"), M(document.body, "focusin.tabguard"), S(document.body, "focusin.tabguard", function(e) {
                                    if (i.node.wrpr.matches(".mm-wrapper_opened")) {
                                        ...
                                        if (t.matches(".mm-tabend")) {
                                            var n = void 0;
                                            t.parentElement.matches(".mm-menu") && x.node.blck && (n = x.node.blck), t.parentElement.matches(".mm-wrapper__blocker") && (n = v(document.body, ".mm-menu_offcanvas.mm-menu_opened")[0]), (n = n || t.parentElement) && b(n, ".mm-tabstart")[0].focus()
                                        }
                                    }
                        ...
                        s.node.menu.prepend(t), s.node.menu.append(n), b(s.node.menu, ".mm-navbars-top, .mm-navbars-bottom").forEach(function(e) {
                            e.querySelectorAll(".mm-navbar__title").forEach(function(e) {
                                e.setAttribute("tabindex", "-1")
                            })
                        })
                    }), this.bind("initBlocker:after", function() {
                        x.node.blck.append(i), b(x.node.blck, "a")[0].classList.add("mm-tabstart")
                    });
        ...
        lazySubmenus: function() {
            ...
            this.opts.lazySubmenus = l(t, x.options.lazySubmenus), t.load && (this.bind("initMenu:after", function() {
                var t = [];
                ...
                var t = ".mm-panel_lazysubmenu",
                    n = v(e, t);
                e.matches(t) && n.unshift(e), (n = n.filter(function(e) {
                    return !e.matches(".mm-panel_lazysubmenu .mm-panel_lazysubmenu")
                })).forEach(function(e) {
                    i.initPanel(e)
                })
        ...
        pageScroll: function() {
            ...
            if (t.scroll && this.bind("close:finish", function() {
                    ...
                    if (i = null, t.inMenu) {
                        var n = e.getAttribute("href");
                        if (i = r(n)) return s.node.menu.matches(".mm-menu_sidebar-expanded") && s.node.wrpr.matches(".mm-wrapper_sidebar-expanded") ? void o() : {
                            close: !0
                        }
                    }
                }), t.update) {
        ...
        searchfield: function() {
            ...
            this.opts.searchfield = l(i, x.options.searchfield), this.conf.searchfield, i.add && (this.bind("close:start", function() {
                ...
                i.panel.add && (t = function() {
                    ...
                    if (t) return t;
                    t = h("div.mm-panel.mm-panel_search.mm-hidden"), e.panel.id && (t.id = e.panel.id), e.panel.title && (t.dataset.mmTitle = e.panel.title);
                    var n = h("ul");
                ...
                n.forEach(function(e) {
                    ...
                    if (e) {
                        var t = this.opts.searchfield;
                        if (this.conf.searchfield, e.closest(".mm-panel") || (e = b(this.node.pnls, ".mm-panel")[0]), !b(e, ".mm-panel__noresultsmsg").length) {
        ...
        sectionIndexer: function() {
            ...
            this.opts.sectionIndexer = l(t, x.options.sectionIndexer), t.add && this.bind("initPanels:after", function() {
                if (!a.node.indx) {
                    ...
                    e.innerHTML = t, a.node.pnls.prepend(e), a.node.indx = e, a.node.indx.addEventListener("click", function(e) {
                    ...
                    var n = function(e) {
                        if (e.target.matches("a")) {
                            var t = e.target.textContent,
                                ...
                                i = -1,
                                s = n.scrollTop;
                            n.scrollTop = 0, v(n, ".mm-divider").filter(function(e) {
                                return !e.matches(".mm-hidden")
                            }).forEach(function(e) {
                    ...
                    A ? (a.node.indx.addEventListener("touchstart", n), a.node.indx.addEventListener("touchmove", n)) : a.node.indx.addEventListener("mouseover", n)
                }
        ...
        setSelected: function() {
            ...
            if (this.opts.setSelected = l(t, x.options.setSelected), "detect" == t.current) {
                var s = function(e) {
                    e = e.split("?")[0].split("#")[0];
        ...
        sidebar: function() {
            ...
            if (this.opts.offCanvas) {
                ...
                if (this.opts.sidebar = l(i, x.options.sidebar), i.collapsed.use) {
                    this.bind("initMenu:after", function() {
                        if (n.node.menu.classList.add("mm-menu_sidebar-collapsed"), i.collapsed.blockMenu && n.opts.offCanvas && !b(n.node.menu, ".mm-menu__blocker")[0]) {
                            var e = h("a.mm-menu__blocker");
                            e.setAttribute("href", "#" + n.node.menu.id), n.node.menu.prepend(e)
                        }
                        i.collapsed.hideNavbar && n.node.menu.classList.add("mm-menu_hidenavbar"), i.collapsed.hideDivider && n.node.menu.classList.add("mm-menu_hidedivider")
                    });
                    var t = function() {
                ...
                if (i.expanded.use) {
                    ...
                    }, "boolean" == typeof i.expanded.use ? this.bind("initMenu:after", t) : E(i.expanded.use, t, s), this.bind("close:start", function() {
                        n.node.wrpr.matches(".mm-wrapper_sidebar-expanded") && (n.node.wrpr.classList.add("mm-wrapper_sidebar-closed"), "remember" == i.expanded.initial && window.localStorage.setItem("mmenuExpandedState", "closed"))
                    }), this.bind("open:start", function() {
                        n.node.wrpr.matches(".mm-wrapper_sidebar-expanded") && (n.node.wrpr.classList.remove("mm-wrapper_sidebar-closed"), "remember" == i.expanded.initial && window.localStorage.setItem("mmenuExpandedState", "open"))
                    });
        ...
        bootstrap: function() {
            ...
            if (this.node.menu.matches(".navbar-collapse")) {
                ...
                var e = h("nav"),
                    s = h("div");
                e.append(s), b(this.node.menu).forEach(function(e) {
                    switch (!0) {
                        case e.matches(".navbar-nav"):
                            s.append((t = e, i = h("ul"), v(t, ".nav-item").forEach(function(e) {
                                var t = h("li");
                ...
                if (t) {
                    ...
                    i && (delete i.dataset.target, i.removeAttribute("aria-controls"), i.outerHTML = i.outerHTML, (i = t.querySelector(".navbar-toggler")).addEventListener("click", function(e) {
                        e.preventDefault(), e.stopImmediatePropagation(), n[n.vars.opened ? "close" : "open"]()
                    }))
                }
            }
    ...
    }, t.default = x, window.Mmenu = x, (F = window.jQuery || window.Zepto || null) && (F.fn.mmenu = function(n, i) {
        var s = F();
        return this.each(function(e, t) {
            t.mmApi || (l = new x(t, n, i), (m = F(l.node.menu)).data("mmenu", l.API), s = s.add(m))
        }), s
    })
}]);